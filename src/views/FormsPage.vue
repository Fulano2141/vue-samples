    ...
    <form>
      ...
      <div class="row">
        ...
        >
          ...
          <!-- Use :selected to define a dafault value -->
        </div>
      </div>
      <hr />
      <div class="row">
        <div
          class="col-xs-12 col-sm-8 col-sm-offset-2 com-md-6 col-md-offset-3"
        >
          <Switchs v-model="dataSwitch"></Switchs>
        </div>
      </div>
      <hr />
      <div class="row">
...
<script>
import Switchs from "../components/Forms/Switchs.vue";
export default {
  data() {
    return {
      userData: {
